...
public class TestKmsEncrypt {
    ...
    public static void test(KMS_JILI kms_siwei, String para_kmsuser,String para_kmspassword,String para_name,String para_plainPath,String para_encryptPathint,String para_method,String iv,int threadNum, int count) {
        ...
        for (int i = 0; i < threadNum; i++) {
            new Thread(new KmsEncrypt(kms_siwei, para_kmsuser, para_kmspassword, para_name,para_plainPath,para_encryptPathint,para_method,iv, count)).start();
        }
...
//    }
    ...
    public static class KmsEncrypt implements Runnable {
        ...
        public KmsEncrypt(KMS_JILI kms_siwei, String para_kmsuser,String para_kmspassword,String para_name,String para_plainPath,String para_encryptPathint,String para_method, String para_iv,int count) {
            okCount = 0;
            failCount = 0;
            exCount = 0;
            running = true;
...
//                    System.out.println(JSONObject.toJSONString(weitest5));
                    Result result = kms_siwei.encrypt_JILI(para_kmsuser,para_kmspassword,para_plainPath, para_encryptPath, para_name,para_method,para_iv);
