...
//
//    public static void test(KMS_SIWEI kms_siwei, byte[] para_cert_path, String para_algName, byte[] para_plainPath, byte[] para_signPath, int threadNum, int count) {
//
...
//        public static byte[] para_cert_path;
//        public static String para_algName;
//        public static byte[] para_plainPath;
//        public static byte[] para_signPath;
...
//        }
//
//        public KmsVerifyAPI(KMS_SIWEI kms_siwei, byte[] para_cert_path, String para_algName, byte[] para_plainPath, byte[] para_signPath, int count) {
//            okCount = 0;
//            failCount = 0;
//            exCount = 0;
//            running = true;
...
//                try {
//
//                    Result result = kms_siwei.kmsVerifyByte(new String(para_cert_path), para_algName, para_plainPath, para_signPath);
