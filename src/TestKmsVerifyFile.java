...
//
//    public static void test(KMS_SIWEI kms_siwei, byte[] para_cert_path,String para_algName,String para_plainPath,byte[] para_signPath, int threadNum, int count) {
//
...
//        }
//
//        public KmsVerifyFile(KMS_SIWEI kms_siwei,byte[] para_cert_path,String para_algName, String para_plainPath,byte[] para_signPath, int count) {
//            okCount = 0;
//            failCount = 0;
//            exCount = 0;
//            running = true;
...
//                try {
//
//                    Result result = kms_siwei.kmsVerifyFile(new String(para_cert_path), para_algName, para_plainPath, para_signPath);
