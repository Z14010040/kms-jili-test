...
//            while ((running)) {
//                try {
////                    System.out.println("业务用户名："+para_kmsuser);
////                    System.out.println("业务用户密码："+para_kmspassword);
////                    System.out.println("唯一标识："+para_name);
//                    Result result = kms_siwei.getWhiteCert(para_kmsuser, para_kmspassword, para_name);
////                    System.out.println("获取结果："+JSONObject.toJSONString(result));
